...
class Api {
  ...
  Future<http.Response> httpPost(
      String path, String endPoint, Object body) async {
    String basicAuth =
        'Basic ' + base64Encode(utf8.encode('$username:$password'));
    var response = await http.post(Uri.parse('$baseUrl/$path/$endPoint'),
        headers: {'Accept': 'Application/json', 'authorization': basicAuth},
        body: body);
    return response;
  }
  ...
  Future<http.Response> httpPostWithFile(String path, Object body) async {
    ...
    var request =
        http.MultipartRequest('POST', Uri.parse('${baseUrl}/v1/common/'));
    request.headers
        .addAll({'Accept': 'Application/json', 'authorization': basicAuth});
  ...
  Future<http.Response> httpPut(
    ...
    var response = await http.put(Uri.parse('$baseUrl/$path/$endPoint'),
        headers: {'Accept': 'Application/json', 'authorization': basicAuth},
        body: body);
  ...
  Future<http.Response> httpPutWithFile(
    ...
    var request =
        http.MultipartRequest('POST', Uri.parse('${_api.baseUrl}/v1/common/'));
    request.headers
        .addAll({'Accept': 'Application/json', 'authorization': basicAuth});
