  ...
  void initState() {
    ...
    WidgetsBinding.instance.addPostFrameCallback((_) async {
      Provider.of<AuthProvider>(context, listen: false)
        ...
        agentPhone = Provider.of<AuthProvider>(context, listen: false)
            .currentUsr
            .agentPhone;
        Provider.of<TopicProvider>(context, listen: false)
            .getSuggestions(idUser, 1);
        await Provider.of<TopicProvider>(context, listen: false)
            .getReclamations(idUser, 2);
      });
    });
  }
                      ...
                      topicProvider.suggestions.length <= 0
                          ...
                          : Column(
                              children: [
                                ...
                                ReclamationCard(
                                  image:
                                      topicProvider.suggestions.first.userImg,
                                  phone:
                                      topicProvider.suggestions.first.telephone,
                                  reason: topicProvider
                                      .suggestions.first.idtype_reason
                                      .toString(),
                                  rec_id:
                                      topicProvider.suggestions.first.idtopic,
                                  status:
                                      topicProvider.suggestions.first.indicator,
                                  date: topicProvider
                                      .suggestions.first.created_at,
                                  dateToShow: topicProvider
                                      .suggestions.first.created_at,
                                  topic: topicProvider.suggestions.first.reason,
                                  message: topicProvider
                                      .suggestions.first.description,
                                  username:
                                      topicProvider.suggestions.first.usersName,
                                  record:
                                      topicProvider.suggestions.first.record,
                                  code: topicProvider.suggestions.first.code,
                                  agentName:
                                      topicProvider.suggestions.first.agentName,
                                ),
                                SizedBox(
                                  height: 5,
                                ),
                      ...
                      topicProvider.reclamations.length <= 0
                          ...
                          : Column(
                              children: [
                                ...
                                ReclamationCard(
                                  image:
                                      topicProvider.reclamations.first.userImg,
                                  phone: topicProvider
                                      .reclamations.first.telephone,
                                  reason: topicProvider
                                      .reclamations.first.idtype_reason
                                      .toString(),
                                  rec_id:
                                      topicProvider.reclamations.first.idtopic,
                                  status: topicProvider
                                      .reclamations.first.indicator,
                                  date: topicProvider
                                      .reclamations.first.created_at,
                                  dateToShow: topicProvider
                                      .reclamations.first.created_at,
                                  topic:
                                      topicProvider.reclamations.first.reason,
                                  message: topicProvider
                                      .reclamations.first.description,
                                  username: topicProvider
                                      .reclamations.first.usersName,
                                  record:
                                      topicProvider.reclamations.first.record,
                                  code: topicProvider.reclamations.first.code,
                                  agentName: topicProvider
                                      .reclamations.first.agentName,
                                ),
                                SizedBox(height: 5),
                                GestureDetector(
                                  child: Container(
