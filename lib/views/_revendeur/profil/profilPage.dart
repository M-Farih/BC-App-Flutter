  ...
  Widget build(BuildContext context) {
    ...
    final userProvider = Provider.of<UserProvider>(context, listen: true);
      ...
      if(!authProvider.spbusy) {
        ...
        image = authProvider.currentUsr.profileImage != "" ? authProvider.currentUsr.profileImage.replaceAll('"', '') : "https://ui-avatars.com/api/?background=FFFFF&color=2C7DBF&name=$lname+$fname";
                    ...
                    Container(
                      ...
                      decoration: BoxDecoration(
                        ...
                        image: new DecorationImage(
                          image: new AssetImage('assets/images/user-card.png'),
