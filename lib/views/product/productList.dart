    ...
    return WillPopScope(
      onWillPop: () async {
        Navigator.of(context).push(MaterialPageRoute(
            builder: (context) => authProvider.currentUsr.idrole == 3
                      ...
                      productProvider.product.length != 0
                          ? GridView.count(
                              ...
                              children: List.generate(
                                  productProvider.product.length, (index) {
                                return ProductCard(
                                  name: productProvider.product[index].name,
                                  desc: productProvider
                                      .product[index].description,
                                  imgPath: productProvider.product[index].image
                                      .replaceAll('"', '')
                                      .trim(),
                                  id: productProvider.product[index].idproduct
                                      .toString(),
                                  type: widget.type,
                                  isRevendeur:
                                      authProvider.currentUsr.idrole == 3
                          ...
                          : Center(
                              child: Text(authProvider.currentUsr.idrole == 3
