...
class _ListSellersAdminState extends State<ListSellersAdmin> {
  ...
  _onScroll() {
    ...
    if (_scrollController.offset >=
      ...
      Provider.of<UserProvider>(context, listen: false).onEndScroll();
    }
  }
  ...
  Widget build(BuildContext context) {
    ...
    Provider.of<UserProvider>(context, listen: true).onBegin();
        ...
        : Scaffold(
            ...
            body: Padding(
              ...
              child: ListView.builder(
                ...
                itemCount: userProvider.index + 1,
                shrinkWrap: true,
                itemBuilder: (context, index) {
                  Widget result;
                  if(index == userProvider.index){
