                        ...
                        child: authProvider.currentUsr.idrole == 1
                            ...
                            onLongPress: (){
                              ...
                              AwesomeDialog(
                                ...
                                btnOkOnPress: () {
                                  userProvider.updateUsernameAndPassword(userProvider.sellers[index].iduser, nameController.text, passwordController.text);
                                  nameController.text = "";
                            ...
                            onTap: () {
                              ...
                              Navigator.of(context).push(
                                  MaterialPageRoute(builder: (context) => SellerDetails(
                                      ...
                                      profileImg: '${userProvider.sellers[index].profileImage != "" ? userProvider.sellers[index].profileImage.replaceAll('"', '').trim() : "https://ui-avatars.com/api/?background=FFFFF&color=2C7DBF&name=${userProvider.sellers[index].firstName}+${userProvider.sellers[index].lastName}"}'))
                              );
                            })
                            :ListTile(
                            leading: CircleAvatar(
