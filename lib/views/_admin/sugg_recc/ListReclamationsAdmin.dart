                    ...
                    Row(
                      children: [
                        Padding(
                          ...
                          child: Text(
                            widget.idtype_reason == 2
                                ? 'Réclamations'
                                : 'Suggestion',
                            style: TextStyle(
                              color: Color(widget.idtype_reason == 2
                                  ? 0xFFF67B97
                                  : 0xFFFC8F6E),
                              fontSize: 20,
                            ),
                                  ...
                                  child: ListTile(
                                      ...
                                      children: [
                                        Row(
                                          ...
                                          children: [
                                            Container(
                                              child: Text(
                                                '${topicProvider.topics[index].usersName}',
                                    ...
                                    subtitle: Row(
                                      ...
                                      children: [
                                        ...
                                        Text(
                                          '${topicProvider.topics[index].created_at.substring(0, topicProvider.topics[index].created_at.length - 3)}',
                                        ),
                                      ],
                                    ),
                                    leading: CircleAvatar(
                                      backgroundColor: Colors.transparent,
                                      backgroundImage: topicProvider
                                                  .topics[index].userImg !=
                                              ""
                                          ? NetworkImage(
                                              '${topicProvider.topics[index].userImg.toString().replaceAll('"', '').trim()}')
                                          : NetworkImage(
                                              "https://ui-avatars.com/api/?background=FFFFF&color=2C7DBF&name=${topicProvider.topics[index].usersName}",
                                            ),
                                    ),
                                    onTap: () {
                                      Navigator.push(
                                        ...
                                        MaterialPageRoute(
                                          builder: (context) => ReclamationDetails(
                                              ...
                                              status: topicProvider
                                                  .topics[index].indicator,
                                              reason: topicProvider
                                                  .topics[index].idtype_reason
                                                  .toString(),
                                              Message: topicProvider
                                                  .topics[index].description,
                                              rec_id: topicProvider
                                                  .topics[index].idtopic,
                                              date: topicProvider
                                                  .topics[index].created_at,
                                              phone: topicProvider
                                                  .topics[index].telephone,
                                              sellerName: topicProvider
                                                  .topics[index].usersName,
                                              record: topicProvider
                                                  .topics[index].record,
                                              topic: topicProvider
                                                  .topics[index].reason,
